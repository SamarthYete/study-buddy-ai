...
export default function Explain() {
    ...
    const handleExplain = async () => {
      ...
      - Format with Markdown (headers, bullet points).`;
            ...
            console.error(error);
            setOutput(`⚠️ Error: ${error.message || "Something went wrong. Please check your API key."}`);
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="pt-24 pb-12 container mx-auto px-4 max-w-4xl min-h-screen">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-400">
                    Stuck on a tough topic? I'll break it down for you.
                </p>
            </div>
            ...
            <div className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl mb-8">
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white rounded-lg font-medium transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    >
